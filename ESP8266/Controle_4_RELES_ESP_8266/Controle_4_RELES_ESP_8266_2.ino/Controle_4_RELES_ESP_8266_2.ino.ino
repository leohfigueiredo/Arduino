...
const char *ssid = "LudwigEFigueiredo"; //  SSID da sua rede
const char *password = "41992549713"; // senha da sua rede
...
const char* APssid = "ESP8266_LEO"; // para mudar o nome da placa na rede
            ...
            client.println("Rele 1 esta Desligado");
                 ...
                 String buf = "";
                  ...
                  buf += "HTTP/1.1 200 OK\r\nContent-Type: text/html\r\n\r\n<!DOCTYPE HTML>\r\n<html>\r\n";
                    ...
                    buf += "</head>\r\n";
                    buf += "<body>\r\n";
                    buf += "<h1><a href=\"http://www.ESP8266_LEO.com.br/wireless-ct-8f6da\"><span style=\"color:#000000;\">ESP8266</span></a></h1>\r\n";
                
                  
                  buf += "<h3> ESP8266 CONTROLE LIGA/DESLIGA VIA REDE</h3>";
                  ...
                  buf += "<h4>CLIQUE NO BOTÃO PARA ACOINAMENTO</h4>";
                  buf += "</html>\n";
                  
                 client.println ("<button style=\"width:1000px;height:40px;color:green;background-color:#87CEFB\"");
                 client.print(buf);
