...
#define DHTPIN A5 // DEFININDO ENTRADA SENSOR DE TEMPERATURA E HUMIDADE
#define DHTTYPE DHT11 // DEFININDO SENSOR DE HUMIDADE UTILIZADO
...
logfile.println("millis,stamp,datetime,status,temperature(º),Humidity(%)");
#if ECHO_TO_SERIAL
Serial.println("millis,stamp,datetime,status,temperature(º),Humidity(%)");
#endif //ECHO_TO_SERIAL
...
Serial.print(", ");
Serial.print(t); // milliseconds since start
logfile.print(", ");
logfile.println("MOTOR 3 PARADO!");
logfile.print(", ");
logfile.print(t); // milliseconds since start
