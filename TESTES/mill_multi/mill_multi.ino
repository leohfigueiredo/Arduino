    ...
    long OffTime2 = 16000;          // milliseconds of off-time

    int ledPin3 =  9;      // the number of the LED pin
    int ledState3 = LOW;             // ledState used to set the LED
    unsigned long previousMillis3 = 0;        // will store last time LED was updated
    long OnTime3 = 4000;           // milliseconds of on-time
    long OffTime3 = 20000;          // milliseconds of off-time 
    ...
    void loop()
    {
     ...
     unsigned long currentMillis2 = millis();
      ...
      else if ((ledState2 == LOW) && (currentMillis - previousMillis2 >= OffTime2))
      {
       ...
       if((ledState3 == HIGH) && (currentMillis2 - previousMillis3 >= OnTime3))
      {
